    ...
    public class Layout
    {
        ...
        public class LayoutBox
        {
            ...
            public LayoutBox GetInlineContainer()
            {
                switch(BoxType)
                {
                    case BlockNode blockNode:
                        if(Children.Last().BoxType is AnonymousBlock)
                        {
            ...
            private Style.StyledNode GetStyleNode()
            {
                ...
                {
                    case BlockNode blockNode:
                        return blockNode.StyledNode;
                    case InlineNode inlineNode:
                        return inlineNode.StyledNode;
                    default:
        ...
        public class BoxType
        {
            ...
            public BoxType() : this(new Style.StyledNode()) { }
